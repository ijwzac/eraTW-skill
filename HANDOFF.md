...
- **⏳SKILL 汉化在途(第9批,task6)**：6 后台 agent 译 SKILL.md+references(英文那批)+READMEs → 写到 `learning/eratw-skill/zh/`(不覆盖)。**待办：agent 回来我核对质量→交用户核对→最后 zh/ 替换原文**。12-16 已中文、08 名表 跳过。
